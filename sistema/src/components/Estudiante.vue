...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'New Estudent' : 'Update Estudent'
            }
        },
        ...
        methods:{
            listar(){
                ...
                axios.get('/api/users/students',configuracion).then(function(response){
            ...
            guardar () {
                ...
                if (this.editedIndex > -1) {
                    //Código para editar
                    let me=this;
                    axios.put('/api/users/students' + me.id,{
